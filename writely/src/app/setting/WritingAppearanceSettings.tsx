...
const controlClassName =
  "mt-2.5 h-[46px] w-full appearance-none rounded-none border border-(--w-border) bg-(--w-background) px-3.5 text-sm text-(--w-foreground) outline-none hover:border-(--w-foreground)";
