"use client";
import SettingsSection from "./SettingsPageContent";
      ...
      <article className="mx-auto max-w-3xl pb-8">
        ...
        <div className="divide-y divide-(--w-border-soft)">
          ...
          <SettingsSection title="Privacy">
            ...
            <Link
              href="/privacy"
              className="mt-5 inline-flex font-medium text-(--w-strong) underline decoration-(--w-subtle) underline-offset-4 hover:text-(--w-foreground)"
            >
