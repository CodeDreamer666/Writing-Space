...
export default function DocItem({
  ...
  }, [isDeleteDialogOpen, isDeleting, closeDialog]);
          ...
          >
            ...
            >
              <rect
                ...
                height="38"
                rx="4"
                fill="var(--w-border-soft)"
              />
              <path d="M22 0 L32 10 L22 10 Z" fill="var(--w-border)" />
              <line
                x1="7"
                y1="17"
                x2="25"
                y2="17"
                stroke="var(--w-placeholder)"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
              <line
      ...
      {isDeleteDialogOpen && (
        ...
        >
          <section
            ...
            className="w-full max-w-sm rounded-2xl border border-[#4B2E2A] bg-[var(--w-surface)] p-6 sm:p-7"
          >
            <h2
              id={`delete-title-${id}`}
