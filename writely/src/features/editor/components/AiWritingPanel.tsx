...
const rewriteActions: Array<{
    ...
    description: string;
        ...
        },
        {
            ...
            description: "Remove repeated words and ideas without losing meaning.",
        },
    ];
...
const actionLabels: Record<AiAction, string> = {
    ...
    improveWordChoice: "Improve word choice",
    ...
    return (
        <>
            ...
            <aside
                ...
                aria-hidden={!isOpen}
                inert={!isOpen}
                className={`fixed inset-y-0 right-0 z-50 flex h-dvh w-[min(100%,420px)] transform-gpu flex-col overflow-hidden border-l border-[var(--w-border)] bg-[var(--w-surface)]/98 shadow-[-24px_0_80px_rgba(0,0,0,0.48)] backdrop-blur-xl transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform motion-reduce:transition-none ${isOpen ? "translate-x-0" : "pointer-events-none translate-x-full"
                    }`}
            >
                    ...
                    <div className="ai-panel-scrollbar min-h-0 flex-1 space-y-5 overflow-y-auto overscroll-contain px-4 py-4 sm:px-5 sm:py-5">
                        <div>
                            ...
                            <select
                                ...
                                className="h-11 w-full cursor-pointer rounded-lg border border-[var(--w-border-soft)] bg-[var(--w-background)] px-3 text-sm text-[var(--w-strong)] outline-none hover:border-[var(--w-border)] disabled:cursor-wait disabled:opacity-60"
                            >
                            ...
                            <p className="mt-2 text-xs leading-relaxed text-[var(--w-subtle)]">
                        ...
                        {aiEnabled ? (
                            <div className="rounded-xl border border-[var(--w-border)] bg-[var(--w-surface-raised)] px-3.5 py-3">
                                ...
                                >
                                    <div
                                        className="h-full rounded-full bg-[var(--w-foreground)]"
