      ...
      <div className="mx-auto flex h-14 w-full max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <button
            disabled={isSaving}
            onClick={onSave}
            className="flex h-8 cursor-pointer items-center gap-2 rounded-lg border border-[#2A313C] bg-[#121820] px-3 text-xs font-medium text-[#D5D9DF] transition-colors hover:border-[#394352] hover:text-[#F5F5F7] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#8E96A3] disabled:cursor-wait disabled:opacity-60"
          >
            {isSaving ? (
              <>
                <LoadingIcon />
