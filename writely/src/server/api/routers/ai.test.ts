      ...
      choices: [
        {
          ...
          message: {
            content:
              '{"improved":"<p>Clearer sentence.</p>","changes":"The sentence is clearer. The wording is more direct. The meaning is preserved."}',
          },
        },
      ],
      usage: {
      ...
      choices: [
        {
          ...
          message: {
            content:
              '{"improved":"<p>A response.</p>","changes":"The sentence is clearer. The wording is more direct. The meaning is preserved."}',
          },
        },
      ],
    });
